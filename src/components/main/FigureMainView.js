const FigureMainView = ({country, children}) => {
	return (
		<figure className='w-full my-6 font-medium md:my-0 md:items-grow flex flex-col sm:text-lg md:text-xl cursor-pointer dark:text-white'>
